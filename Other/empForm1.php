    ...
    <div class="container-fluid col-md-6">
        ...
        <form class="m-3" method="post" id="form" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-3">
                ...
                <input type="hidden" id="validPhone">
            ...
            <div class="form-outline mb-3">
                ...
                <input type="hidden" id="validImage">
...
<script>
    ...
    $(document).on('click', '#addEmp', function() {
        ...
        if ($okName == 'success' && $okEmail == 'success' && $okPhone == 'success') {
            if ($("#form").valid()) {
                $.ajax({
                    type: "POST",
                    url: 'allAction.php',
            ...
            $("#msg").html('Please, Enter Valid details in All fields.');
        }
    });
